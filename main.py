...
sidebar.write("**GitHub**: https://github.com/Umidjonjuraqulov")
#col1.sidebar.image("images/git_hup_logo.PNG",width=30)
sidebar.write("[**Instagram**](https://instagram.com/juraqulov_umidjon2003)")
#col1.sidebar.image("images/instagram_logo.PNG",width=30)
sidebar.write("[**Facebook**](https://www.facebook.com/profile.php?id=100079703570952&mibextid=ZbWKwL)")
